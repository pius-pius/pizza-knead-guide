...
const translations = {
  ...
  "save.btn": { it: "Salva ricetta", en: "Save recipe" },
  "save.name_prompt": { it: "Nome della ricetta", en: "Recipe name" },
  "save.login_required": { it: "Accedi per salvare le tue ricette", en: "Sign in to save your recipes" },
  "save.success": { it: "Ricetta salvata!", en: "Recipe saved!" },
  "save.error": { it: "Errore nel salvataggio", en: "Error saving" },

  // ── Auth ──
  "auth.login": { it: "Accedi", en: "Sign in" },
  "auth.register": { it: "Registrati", en: "Sign up" },
  "auth.logout": { it: "Esci", en: "Sign out" },
  "auth.profile": { it: "Profilo", en: "Profile" },
  "auth.my_recipes": { it: "Le mie ricette", en: "My recipes" },
  "auth.back_home": { it: "Torna alla home", en: "Back to home" },
  "auth.fill_fields": { it: "Compila tutti i campi", en: "Fill in all fields" },
  "auth.enter_email": { it: "Inserisci l'email", en: "Enter your email" },
  "auth.password_min": { it: "La password deve avere almeno 6 caratteri", en: "Password must be at least 6 characters" },
  "auth.password_mismatch": { it: "Le password non corrispondono", en: "Passwords don't match" },
  "auth.forgot_password": { it: "Password dimenticata?", en: "Forgot password?" },
  "auth.no_account": { it: "Non hai un account?", en: "No account?" },
  "auth.has_account": { it: "Hai già un account?", en: "Already have an account?" },
  "auth.confirm_password": { it: "Conferma password", en: "Confirm password" },
  "auth.full_name": { it: "Nome completo", en: "Full name" },
  "auth.reset_desc": { it: "Inserisci la tua email per ricevere il link di reset.", en: "Enter your email to receive a reset link." },
  "auth.reset_sent": { it: "Email inviata! Controlla la tua casella.", en: "Email sent! Check your inbox." },
  "auth.send_reset": { it: "Invia link di reset", en: "Send reset link" },
  "auth.back_to_login": { it: "Torna al login", en: "Back to login" },
  "auth.signup_success_title": { it: "Registrazione completata!", en: "Registration complete!" },
  "auth.signup_success_desc": { it: "Controlla la tua email per confermare l'account.", en: "Check your email to confirm your account." },
  "auth.go_to_login": { it: "Vai al login", en: "Go to login" },
  "auth.active": { it: "Attivo", en: "Active" },
  "auth.inactive": { it: "Non attivo", en: "Inactive" },
  "auth.member_since": { it: "Iscritto dal", en: "Member since" },
  "auth.save_profile": { it: "Salva profilo", en: "Save profile" },
  "auth.saved": { it: "Salvato!", en: "Saved!" },
  "auth.new_password": { it: "Nuova password", en: "New password" },
  "auth.update_password": { it: "Aggiorna password", en: "Update password" },
  "auth.password_updated": { it: "Password aggiornata!", en: "Password updated!" },
  "auth.invalid_reset_link": { it: "Link di reset non valido.", en: "Invalid reset link." },

  // ── My Recipes ──
  "myrecipes.search": { it: "Cerca ricette...", en: "Search recipes..." },
  "myrecipes.sort_updated": { it: "Ordina per ultimo aggiornamento", en: "Sort by last updated" },
  "myrecipes.sort_created": { it: "Ordina per creazione", en: "Sort by creation" },
  "myrecipes.empty": { it: "Nessuna ricetta salvata", en: "No saved recipes" },
  "myrecipes.no_results": { it: "Nessun risultato", en: "No results" },
  "myrecipes.create_first": { it: "Crea la tua prima ricetta", en: "Create your first recipe" },
  "myrecipes.confirm_delete": { it: "Sei sicuro di voler eliminare questa ricetta?", en: "Are you sure you want to delete this recipe?" },
  "myrecipes.deleted": { it: "Ricetta eliminata", en: "Recipe deleted" },
  "myrecipes.duplicated": { it: "Ricetta duplicata", en: "Recipe duplicated" },
  "myrecipes.copy": { it: "copia", en: "copy" },
  "myrecipes.load": { it: "Carica nel calcolatore", en: "Load into calculator" },
  "myrecipes.duplicate": { it: "Duplica", en: "Duplicate" },
  "myrecipes.delete": { it: "Elimina", en: "Delete" },
  "myrecipes.loaded": { it: "Ricetta caricata nel calcolatore!", en: "Recipe loaded into calculator!" },
} as const;
